...
export const SKILLS: ISkill[] = [{
    ...
    name: 'DevOps',
    text: 'Solid understanding of IP based networks, ' +
        'command line tools such as git and ssh, ' +
        'operating systems such as Ubuntu Server, ' +
        'and server environments such as Docker. ' +
        'Familiar with Google Cloud App Engine and AWS.',
    image: 'assets/imgs/terminal.png',
}];
